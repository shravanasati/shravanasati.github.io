...
summary: This article talks about the architectural decisions behind everynyan.
hero: hero.png
---
...
![an image of otp doc from the database](/everynyan-architecture/otp.png)



And this is a screenshot of a sample document from the tokens collection.

![an image of token doc from the database](/everynyan-architecture/token.png)
...
![initially planned notifications system architecture](/everynyan-architecture/notifications.png)
